//! SQL parser implementation using nom combinator library.
//!
//! This module provides functions to parse SQL statements into AST nodes.
...
/// Parses primary expressions (literals, columns, parenthesized expressions).
